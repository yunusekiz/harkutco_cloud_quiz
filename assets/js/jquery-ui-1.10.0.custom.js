...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		prevText: "Önceki Ay", // Display text for previous month link
		nextText: "Sonraki Ay", // Display text for next month link
		...
		dayNamesShort: ["Pzr", "Pzt", "Sal", "Çrş", "Prş", "Cum", "Cmt"], // For formatting
		dayNamesMin: ["Pzr", "Pzt", "Sal", "Çrş", "Prş", "Cum", "Cmt"], // Column headings for days starting at Sunday
